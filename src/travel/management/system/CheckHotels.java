...
public class CheckHotels extends JFrame implements Runnable {
    ...
    @Override
    public void run() {
        String[] text = new String[]{"JW Marriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Rasdisson Blue Hotel","Classico Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
    ...
    CheckHotels() {
        ...
        caption.setFont(new Font("Candara",Font.BOLD,40));
